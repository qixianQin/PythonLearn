...
class GoogleCacheMiddleware(object):
	"""
		...
		you can define the GOOGLE_CACHE_DOMAIN in settings, it is a list which you want to visit the google cache. 
		Or you can define a google_cache_domains in you spider and it is as the highest priority. 
	"""

	google_cache = 'http://webcache.googleuserrcontent.com/search?q=cache:'
